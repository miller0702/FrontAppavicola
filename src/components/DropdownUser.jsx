...
import Perfil from '../assets/images/Logo.png'
import { FaClosedCaptioning, FaSignOutAlt, FaTools, FaUser } from 'react-icons/fa';
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">{usuario && usuario.lastname}</span>
        </span>

        <span className="h-12 w-12 rounded-full">
          <img
            src={(usuario && usuario.image) || Perfil}
            alt="User"
