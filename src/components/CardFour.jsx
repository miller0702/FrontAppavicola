...
const CardFour = () => {
  const [totalInsumos, setTotalInsumos] = useState("")
  useEffect(() =>{
    getTotalInsumos()
  }, [])
  ...
  const getTotalInsumos = async () => {
    try {
      ...
      setTotalInsumos(data.totalcompras)
    } catch (error) {
      console.log(error)
    }
  }
    ...
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          ...
          <span className="text-sm font-medium">Egresos generados por los Insumos Adquiridos</span>
        </div>
